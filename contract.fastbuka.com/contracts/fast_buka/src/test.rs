...
fn test_get_vendor_pending_orders() {
    ...
    let order1_id = client.create_order(&user1, &token_address, &vendor1, &500, &50);
    let order2_id = client.create_order(&user1, &token_address, &vendor1, &300, &30);
    let order2_id = client.create_order(&user1, &token_address, &vendor1, &300, &30);

    let order3_id = client.create_order(&user1, &token_address, &vendor2, &300, &30);
